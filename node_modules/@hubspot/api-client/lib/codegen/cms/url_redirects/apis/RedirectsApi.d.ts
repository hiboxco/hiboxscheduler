...
export declare class RedirectsApiRequestFactory extends BaseAPIRequestFactory {
    ...
    getPage(createdAt?: Date, createdAfter?: Date, createdBefore?: Date, updatedAt?: Date, updatedAfter?: Date, updatedBefore?: Date, sort?: Array<string>, properties?: Array<string>, after?: string, before?: string, limit?: number, archived?: boolean, _options?: Configuration): Promise<RequestContext>;
...
export declare class RedirectsApiResponseProcessor {
    ...
    getPage(response: ResponseContext): Promise<CollectionResponseWithTotalUrlMapping>;
