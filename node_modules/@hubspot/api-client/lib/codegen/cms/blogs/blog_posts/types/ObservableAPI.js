...
class ObservableBlogPostsApi {
    ...
    archiveBatch(batchInputString, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.archiveBatch(rsp)));
        }));
    }
    attachToLangGroup(attachToLangPrimaryRequestVNext, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.attachToLangGroup(rsp)));
        }));
    }
    clone(contentCloneRequestVNext, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.clone(rsp)));
        }));
    }
    ...
    createBatch(batchInputBlogPost, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.createBatch(rsp)));
        }));
    }
    createLangVariation(blogPostLanguageCloneRequestVNext, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.createLangVariation(rsp)));
        }));
    }
    detachFromLangGroup(detachFromLangGroupRequestVNext, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.detachFromLangGroup(rsp)));
        }));
    }
    ...
    getDraftById(objectId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getDraftById(rsp)));
        }));
    }
    ...
    getPreviousVersion(objectId, revisionId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getPreviousVersion(rsp)));
        }));
    }
    getPreviousVersions(objectId, after, before, limit, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getPreviousVersions(rsp)));
        }));
    }
    pushLive(objectId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.pushLive(rsp)));
        }));
    }
    readBatch(batchInputString, archived, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.readBatch(rsp)));
        }));
    }
    resetDraft(objectId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.resetDraft(rsp)));
        }));
    }
    restorePreviousVersion(objectId, revisionId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.restorePreviousVersion(rsp)));
        }));
    }
    restorePreviousVersionToDraft(objectId, revisionId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.restorePreviousVersionToDraft(rsp)));
        }));
    }
    schedule(contentScheduleRequestVNext, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.schedule(rsp)));
        }));
    }
    setLangPrimary(setNewLanguagePrimaryRequestVNext, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.setLangPrimary(rsp)));
        }));
    }
    ...
    updateDraft(objectId, blogPost, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.updateDraft(rsp)));
        }));
    }
    updateLangs(updateLanguagesRequestVNext, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.updateLangs(rsp)));
        }));
    }
}
