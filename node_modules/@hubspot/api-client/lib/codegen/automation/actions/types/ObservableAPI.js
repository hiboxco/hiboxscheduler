...
class ObservableCallbacksApi {
    ...
    complete(callbackId, callbackCompletionRequest, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.complete(rsp)));
        }));
    }
    completeBatch(batchInputCallbackCompletionBatchRequest, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.completeBatch(rsp)));
        }));
    }
}
...
class ObservableFunctionsApi {
    ...
    archiveByFunctionType(definitionId, functionType, appId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.archiveByFunctionType(rsp)));
        }));
    }
    createOrReplace(definitionId, functionType, functionId, appId, body, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.createOrReplace(rsp)));
        }));
    }
    createOrReplaceByFunctionType(definitionId, functionType, appId, body, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.createOrReplaceByFunctionType(rsp)));
        }));
    }
    getByFunctionType(definitionId, functionType, appId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getByFunctionType(rsp)));
        }));
    }
