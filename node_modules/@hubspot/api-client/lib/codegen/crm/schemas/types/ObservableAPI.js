...
class ObservableCoreApi {
    ...
    archiveAssociation(objectType, associationIdentifier, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.archiveAssociation(rsp)));
        }));
    }
    ...
    createAssociation(objectType, associationDefinitionEgg, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.createAssociation(rsp)));
        }));
    }
...
class ObservablePublicObjectSchemasApi {
    ...
    purge(objectType, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.purge(rsp)));
        }));
    }
}
