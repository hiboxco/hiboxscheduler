...
class ObservableEventsApi {
    ...
    getDetailById(eventTemplateId, eventId, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getDetailById(rsp)));
        }));
    }
    getRenderById(eventTemplateId, eventId, detail, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getRenderById(rsp)));
        }));
    }
}
