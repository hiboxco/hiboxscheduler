...
class PromiseAssociationsApi {
    ...
    archive(taskId, toObjectType, toObjectId, associationType, _options) {
        const result = this.api.archive(taskId, toObjectType, toObjectId, associationType, _options);
        return result.toPromise();
    }
    create(taskId, toObjectType, toObjectId, associationType, _options) {
        const result = this.api.create(taskId, toObjectType, toObjectId, associationType, _options);
        return result.toPromise();
    }
