...
class PromiseAssociationsApi {
    ...
    archive(emailId, toObjectType, toObjectId, associationType, _options) {
        const result = this.api.archive(emailId, toObjectType, toObjectId, associationType, _options);
        return result.toPromise();
    }
    create(emailId, toObjectType, toObjectId, associationType, _options) {
        const result = this.api.create(emailId, toObjectType, toObjectId, associationType, _options);
        return result.toPromise();
    }
