...
export declare class ObservableAssociationsApi {
    ...
    archive(emailId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<void>;
    create(emailId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations>;
    getAll(emailId: string, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Observable<CollectionResponseAssociatedIdForwardPaging>;
}
