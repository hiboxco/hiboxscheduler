...
export declare class ObservableAssociationsApi {
    ...
    archive(noteId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<void>;
    create(noteId: string, toObjectType: string, toObjectId: string, associationType: string, _options?: Configuration): Observable<SimplePublicObjectWithAssociations>;
    getAll(noteId: string, toObjectType: string, after?: string, limit?: number, _options?: Configuration): Observable<CollectionResponseAssociatedIdForwardPaging>;
}
