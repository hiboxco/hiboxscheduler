...
class AssociationsApiRequestFactory extends baseapi_1.BaseAPIRequestFactory {
    archive(dealId, toObjectType, toObjectId, associationType, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v3/objects/deals/{dealId}/associations/{toObjectType}/{toObjectId}/{associationType}'
    ...
    getAll(dealId, toObjectType, after, limit, _options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const localVarPath = '/crm/v3/objects/deals/{dealId}/associations/{toObjectType}'
                .replace('{' + 'dealId' + '}', encodeURIComponent(String(dealId)))
                .replace('{' + 'toObjectType' + '}', encodeURIComponent(String(toObjectType)));
