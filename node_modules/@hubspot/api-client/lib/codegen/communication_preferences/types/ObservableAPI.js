...
class ObservableStatusApi {
    ...
    getEmailStatus(emailAddress, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.getEmailStatus(rsp)));
        }));
    }
    subscribe(publicUpdateSubscriptionStatusRequest, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.subscribe(rsp)));
        }));
    }
    unsubscribe(publicUpdateSubscriptionStatusRequest, _options) {
        ...
        return middlewarePreObservable.pipe(rxjsStub_2.mergeMap((ctx) => this.configuration.httpApi.send(ctx))).
            ...
            return middlewarePostObservable.pipe(rxjsStub_2.map((rsp) => this.responseProcessor.unsubscribe(rsp)));
        }));
    }
}
