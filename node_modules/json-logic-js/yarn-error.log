Arguments: 
  /usr/local/Cellar/node/9.8.0/bin/node /usr/local/bin/yarn run build

PATH: 
  /Users/jwadhams/.yarn/bin:/usr/local/bin:/usr/local/sbin:/Users/jwadhams/.npm-packages/bin:/usr/local/bin:/usr/bin:/bin:/usr/sbin:/sbin:/Users/jwadhams/.composer/vendor/bin:vendor/bin
...
Trace: 
  ...
  Exit code: 2
  Command: sh
  Arguments: -c webpack --mode production
  Directory: /Users/jwadhams/github/json-logic-js
  Output:
