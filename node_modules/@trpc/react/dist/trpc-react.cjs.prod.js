...
function createReactQueryHooks() {
  ...
  function TRPCProvider(props) {
    ...
    var _useState = React.useState(props.ssrState || (props.isPrepass ? 'prepass' : false)),
    ...
    return /*#__PURE__*/React__default['default'].createElement(Context.Provider, {
      value: {
         ...
         */
        invalidateQuery: React.useCallback(function () {
  ...
  function useQuery(pathAndInput, opts) {
    ...
    return reactQuery.useQuery(pathAndInput, function () {
      var _ref7;
  ...
  function useMutation(path, opts) {
    ...
    return reactQuery.useMutation(function (input) {
  ...
  function useInfiniteQuery(pathAndInput, opts) {
    ...
    var actualOpts = useSSRQueryOptionsIfNeeded(pathAndInput, opts);
    return reactQuery.useInfiniteQuery(pathAndInput, function (_ref8) {
      var _ref9, _ref10;
