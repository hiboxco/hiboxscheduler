 ...
 */
export declare const ADDRESS: ["postcode_by_state", "postcode", "city_name", "city_prefix", "city_suffix", "country", "state", "state_abbr", "county", "direction_abbr", "direction", "building_number", "street_prefix", "street_suffix", "street_address", "secondary_address", "country_code", "country_code_alpha_3", "time_zone"];
