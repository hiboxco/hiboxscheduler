...
describe('phoneInputHelpers', function () {
  ...
  it('should migrate parsed input for new country', function () {
    ...
    (0, _phoneInputHelpers.getPhoneDigitsForNewCountry)('8', {
      prevCountry: 'RU',
      metadata: _metadataMin["default"] // }).should.equal('')
  ...
  it('should format phone number in e164', function () {
    ...
    (0, _phoneInputHelpers.e164)('+7800', null, _metadataMin["default"]).should.equal('+7800'); // National number. Without country.

    expect((0, _phoneInputHelpers.e164)('8800', null, _metadataMin["default"])).to.be.undefined; // National number. With country. Just national prefix.
    // expect(e164('8', 'RU', metadata)).to.be.undefined

    (0, _phoneInputHelpers.e164)('8', 'RU', _metadataMin["default"]).should.equal('+7'); // National number. With country.
