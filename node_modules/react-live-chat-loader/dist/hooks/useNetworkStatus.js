...
var useNetworkStatus = function useNetworkStatus() {
  if (window.navigator && 'connection' in navigator && 'effectiveType' in navigator.connection) {
    unsupported = false;
  } else {
    unsupported = true;
  }

  var initialNetworkStatus = !unsupported ? {
    effectiveConnectionType: navigator.connection.effectiveType
  } : {
    unsupported: unsupported
  };

  var _useState = (0, _react.useState)(initialNetworkStatus),
  ...
  (0, _react.useEffect)(function () {
    if (!unsupported) {
      ...
      var updateECTStatus = function updateECTStatus() {
        setNetworkStatus({
  ...
  return _objectSpread({}, networkStatus, {
    setNetworkStatus: setNetworkStatus
  });
};

var _default = useNetworkStatus;
