...
var UserApi = /** @class */ (function () {
    function UserApi(baseURL, axios) {
        this.baseURL = baseURL;
        this.client = axios;
    }
    UserApi.prototype.create = function (clientUserId) {
        return __awaiter(this, void 0, void 0, function () {
            var resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.post(this.baseURL.concat('/user/key'), {
    ...
    UserApi.prototype.resolve = function (clientUserId) {
        return __awaiter(this, void 0, void 0, function () {
            var resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.get(this.baseURL.concat("/user/key/" + clientUserId))];
                    case 1:
                        resp = _a.sent();
                        return [2 /*return*/, resp.data];
                }
