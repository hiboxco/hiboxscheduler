...
var LinkApi = /** @class */ (function () {
    function LinkApi(baseURL, axios) {
    ...
    LinkApi.prototype.connectProvider = function (linkToken, provider, username, password) {
        return __awaiter(this, void 0, void 0, function () {
            var resp;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.post(this.baseURL.concat("/link/provider/" + provider), {
                            username: username,
                            password: password,
    ...
    LinkApi.prototype.getOAuthLink = function (linkToken, provider) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.client.get(this.baseURL.concat("/link/provider/oauth/" + provider), { headers: { LinkToken: linkToken } })];
                    case 1:
                        resp = _a.sent();
                        return [2 /*return*/, resp.data];
                }
