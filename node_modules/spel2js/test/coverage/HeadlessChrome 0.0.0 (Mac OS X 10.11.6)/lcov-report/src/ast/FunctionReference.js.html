...
<html lang="en">
<head>
    <title>Code coverage report for src/ast/FunctionReference.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/ast/</a> FunctionReference.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    node.getValue = function (state) {
        v</span>ar locals = state.locals || <span class="branch-1 cbranch-no" title="branch not covered" >{},
...
&nbsp;
        if (<span class="missing-if-branch" title="else path not taken" >E</span>locals[functionName]) {
