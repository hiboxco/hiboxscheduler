...
<html lang="en">
<head>
    <title>Code coverage report for src/Tokenizer.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../index.html">all files</a> / <a href="index.html">src/</a> Tokenizer.js
    </h1>
    <div class='clearfix'>
      <div class='fl pad1y space-right2'>
        <span class="strong">88.73% </span>
        <span class="quiet">Statements</span>
        <span class='fraction'>244/275</span>
      </div>
      <div class='fl pad1y space-right2'>
        <span class="strong">86.62% </span>
        <span class="quiet">Branches</span>
        <span class='fraction'>136/157</span>
      </div>
      <div class='fl pad1y space-right2'>
      ...
      <div class='fl pad1y space-right2'>
        ...
        <span class='fraction'>203/234</span>
      </div>
      <div class='fl pad1y'>
        <span class="strong">5 statements</span>
...
603
604
605</td><td class="line-coverage quiet"><span class="cline-any cline-neutral">&nbsp;</span>
        ...
        while (pos &lt; max) {
            ...
            if (isAlphabetic(ch)) {
                ...
                case '+':
                    ...
                    break;
                case <span class="branch-1 cbranch-no" title="branch not covered" >'_': // the other way to start an identifier</span>
                    lexIdentifier();
                    break;
                case '-':
                ...
                case '?':
                    ...
                    break;
                case '$':
                    if (<span class="missing-if-branch" title="else path not taken" >E</span>isTwoCharToken(TokenKind.SELECT_LAST)) {
...
&nbsp;
        ...
        if (ch === '.') {
            ...
            while (isDigit(toProcess[pos]));
            if (<span class="missing-if-branch" title="if path not taken" >I</span>pos === dotpos + 1) {
                // the number is something like '3.'. It is really an int but may be
                // part of something like '3.toString()'. In this case process it as
                // an int and leave the dot as a separate token.
                pos = <span class="cstat-no" title="statement not covered" >dotpos;</span>
                pushIntToken(<span class="cstat-no" title="statement not covered" >subarray(start, pos), false, start, pos);</span>
                return;
            }
        }
&nbsp;
...
&nbsp;
        ...
        else <span class="missing-if-branch" title="if path not taken" >I</span>if (isExponentChar(toProcess[pos])) {
            isReal = <span class="cstat-no" title="statement not covered" >true; // if it wasn't before, it is now</span>
            pos += <span class="cstat-no" title="statement not covered" >1;</span>
            possibleSign = <span class="cstat-no" title="statement not covered" >toProcess[pos];</span>
            if (<span class="cstat-no" title="statement not covered" >isSign(possibleSign)) {</span>
                pos += <span class="cstat-no" title="statement not covered" >1;</span>
            }
&nbsp;
            // exponent digits
            do <span class="cstat-no" title="statement not covered" >{</span>
                pos += <span class="cstat-no" title="statement not covered" >1;</span>
            }
            while (isDigit(toProcess[pos]));
            isFloat = <span class="cstat-no" title="statement not covered" >false;</span>
            if (<span class="cstat-no" title="statement not covered" >isFloatSuffix(toProcess[pos])) {</span>
                isFloat = <span class="cstat-no" title="statement not covered" >true;</span>
                pos += <span class="cstat-no" title="statement not covered" >1;</span>
                endOfNumber = <span class="cstat-no" title="statement not covered" >pos;</span>
            }
            else <span class="cstat-no" title="statement not covered" >if (isDoubleSuffix(toProcess[pos])) {</span>
                pos += <span class="cstat-no" title="statement not covered" >1;</span>
                endOfNumber = <span class="cstat-no" title="statement not covered" >pos;</span>
            }
            pushRealToken(<span class="cstat-no" title="statement not covered" >subarray(start, pos), isFloat, start, pos);</span>
        }
        else {
            ch = toProcess[pos];
            isFloat = false;
            ...
            else <span class="missing-if-branch" title="if path not taken" >I</span>if (isDoubleSuffix(ch)) {
                isReal = <span class="cstat-no" title="statement not covered" >true;</span>
                pos += <span class="cstat-no" title="statement not covered" >1;</span>
                endOfNumber = <span class="cstat-no" title="statement not covered" >pos;</span>
            }
            if (isReal) {
...
&nbsp;
        ...
        if ((pos - start) === 2 || (pos - start) === 3) {
            ...
            if (<span class="missing-if-branch" title="if path not taken" >I</span>idx &gt;= 0) {
                pushOneCharOrTwoCharToken(<span class="cstat-no" title="statement not covered" >TokenKind.valueOf(asString), start, substring);</span>
                return;
            }
        }
...
&nbsp;
    function pushHexIntToken(data, isLong, start, end) {
        if (<span class="missing-if-branch" title="if path not taken" >I</span>data.length === 0) {
            if (<span class="cstat-no" title="statement not covered" >isLong) {</span>
...
&nbsp;
    ...
    function isTwoCharToken(kind) {
        if (<span class="missing-if-branch" title="else path not taken" >E</span>kind.tokenChars.length === 2 &amp;&amp; toProcess[pos] === kind.tokenChars[0]) {
...
&nbsp;
    function <span class="fstat-no" title="function not covered" >pushOneCharOrTwoCharToken(kind, pos, data) {</span>
        tokens.<span class="cstat-no" title="statement not covered" >push(new Token(kind, data, pos, pos + kind.getLength()));</span>
    }
&nbsp;
...
&nbsp;
    function <span class="fstat-no" title="function not covered" >isSign(ch) {</span>
        return <span class="cstat-no" title="statement not covered" >ch === '+' || ch === '-';</span>
    }
&nbsp;
    function isDigit(ch) {
        if (<span class="missing-if-branch" title="if path not taken" >I</span>ch.charCodeAt(0) &gt; 255) {
            return <span class="cstat-no" title="statement not covered" >false;</span>
        }
