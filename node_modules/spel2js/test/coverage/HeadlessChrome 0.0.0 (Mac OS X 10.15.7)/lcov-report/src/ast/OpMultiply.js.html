...
<html lang="en">
<head>
    <title>Code coverage report for src/ast/OpMultiply.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/ast/</a> OpMultiply.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        if (<span class="missing-if-branch" title="else path not taken" >E</span>typeof leftValue === 'number' &amp;&amp; typeof rightValue === 'number') {
            return leftValue * rightValue;
        }
&nbsp;
        //repeats (ex. 'abc' * 2 = 'abcabc')
        if (<span class="cstat-no" title="statement not covered" >typeof leftValue === 'string' &amp;&amp; typeof  rightValue === 'number') {</span>
            var <span class="cstat-no" title="statement not covered" >s = '',</span>
                i = 0;
            for (; <span class="cstat-no" title="statement not covered" >i &lt; rightValue; i += 1) {</span>
                s += <span class="cstat-no" title="statement not covered" >leftValue;</span>
            }
