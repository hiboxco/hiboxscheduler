...
<html lang="en">
<head>
    <title>Code coverage report for src/ast/OpBetween.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/ast/</a> OpBetween.js
    </h1>
    <div class='clearfix'>
...
<span class="fstat-no" title="function not covered" >function createNode(position, left, right) {</span>
    var <span class="cstat-no" title="statement not covered" >node = SpelNode.create('between', position, left, right);</span>
&nbsp;
    /**
