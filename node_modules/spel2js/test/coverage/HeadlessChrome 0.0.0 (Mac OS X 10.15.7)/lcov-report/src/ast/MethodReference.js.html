...
<html lang="en">
<head>
    <title>Code coverage report for src/ast/MethodReference.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/ast/</a> MethodReference.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
        ...
        function maybeHandleNullSafeNavigation(member) {
            if (<span class="missing-if-branch" title="if path not taken" >I</span>member === undefined || member === null) {
                if (<span class="cstat-no" title="statement not covered" >nullSafeNavigation) {</span>
...
&nbsp;
            if (<span class="missing-if-branch" title="else path not taken" >E</span>methodName === 'contains') {
                return context.includes(compiledArgs[0])
            }
        }
&nbsp;
        method = maybeHandleNullSafeNavigation(context[methodName]);
        if (<span class="missing-if-branch" title="else path not taken" >E</span>method) {
