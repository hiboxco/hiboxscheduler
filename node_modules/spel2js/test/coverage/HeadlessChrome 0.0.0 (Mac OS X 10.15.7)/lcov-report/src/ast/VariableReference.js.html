...
<html lang="en">
<head>
    <title>Code coverage report for src/ast/VariableReference.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/ast/</a> VariableReference.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    node.getRaw = <span class="fstat-no" title="function not covered" >function () {</span>
        return <span class="cstat-no" title="statement not covered" >variableName;</span>
    };
&nbsp;
