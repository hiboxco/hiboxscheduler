...
<html lang="en">
<head>
    <title>Code coverage report for src/ast/PropertyReference.js</title>
    <meta charset="utf-8" />
...
<div class='wrapper'>
  <div class='pad1'>
    <h1>
      <a href="../../index.html">all files</a> / <a href="index.html">src/ast/</a> PropertyReference.js
    </h1>
    <div class='clearfix'>
...
&nbsp;
    node.getRaw = <span class="fstat-no" title="function not covered" >function () {</span>
        return <span class="cstat-no" title="statement not covered" >propertyName;</span>
    };
&nbsp;
...
&nbsp;
        if (!context) {
            if (<span class="missing-if-branch" title="else path not taken" >E</span>nullSafeNavigation) {
                return null;
            }
&nbsp;
...
&nbsp;
            ...
            i</span>f (<span class="missing-if-branch" title="if path not taken" >I</span>propertyName === 'size' &amp;&amp; <span class="branch-1 cbranch-no" title="branch not covered" >Array.isArray(context)) {
                return <span class="cstat-no" title="statement not covered" >context.length;</span>
            }
&nbsp;
            throw {
...
&nbsp;
    node.setValue = function (value, state) {
        var context = state.activeContext.peek();
&nbsp;
        if (<span class="missing-if-branch" title="if path not taken" >I</span>!context) {
            throw <span class="cstat-no" title="statement not covered" >{</span>
                name: 'ContextDoesNotExistException',
