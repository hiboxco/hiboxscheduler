...
- Before jumping into a PR be sure to search [existing PRs](https://github.com/hiboxco/hiboxscheduler/pulls) or [issues](https://github.com/hiboxco/hiboxscheduler/issues) for an open or closed item that relates to your submission.
