...
export default function JoinCall(props: JoinCallPageProps) {
  ...
  return (
    <>
      <Head>
        <title>Hibox Video</title>
        <meta name="title" content="Hibox Video" />
        ...
        <meta property="og:title" content="Hibox Video" />
        ...
        <meta property="twitter:title" content="Hibox Video" />
          ...
          <Link href="/" passHref>
            {
              ...
              <img
                ...
                src={`${WEBSITE_URL}/Hibox-Scheduler-logo-word.svg`}
                alt="Hibox Logo"
                style={{
                  top: 46,
                  left: 24,
