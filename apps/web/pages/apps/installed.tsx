...
function ConnectOrDisconnectIntegrationButton(props: {
  ...
  const { t } = useLocale();
  //console.log(props.credentialKeys);
  const [credentialId] = props.credentialIds;
  //const [credentialKey] = props.credentialKeys;

  const credentialKey = !props.credentialKeys ? null : props.credentialKeys[0];
  ...
  if (credentialId) {
    ...
    //console.log("start", credentialKey);
    //console.log("End", credentialKey);
    return (
      <DisconnectIntegration
        id={credentialId}
                    ...
                    <IntegrationListItem
                      ...
                      actions={
                        <ConnectOrDisconnectIntegrationButton
                          ...
                          type={item.type}
                          credentialKeys={item.credentialKeys}
