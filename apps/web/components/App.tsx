      ...
      <div className="justify-between px-8 py-10 md:flex">
        ...
        <div className="md:max-w-80 flex-1 md:ml-8">
          ...
          <small className="leading-1 block text-gray-500">
            Every app published on the Hibox App Store is open source and thoroughly tested via peer reviews.
            Nevertheless, Hibox, LLC. does not endorse or certify these apps unless they are published by
            Hibox. If you encounter inappropriate content or behaviour please report it.
          </small>
          <a className="mt-2 block text-xs text-red-500" href="mailto:support@hibox.co">
