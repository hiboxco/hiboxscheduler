...
const Layout = ({
  ...
  const navigation = [
    ...
    },
    {
      ...
      href: "/admin/users",
      icon: UserGroupIcon,
      current: router.asPath === "/admin/users",
      adminRequired: true,
    },
  ];
  const pageTitle = typeof props.heading === "string" ? props.heading : props.title;
  /*   const Linkwrapper = ({children, item})=>{(
      const Component = item.adminRequired ? AdminRequired : Fragment;
            ...
            <div className="flex w-14 flex-col lg:w-56">
              <div className="flex h-0 flex-1 flex-col border-r border-gray-200 bg-white">
                ...
                <small style={{ fontSize: "0.5rem" }} className="mx-3 mt-1 mb-2 hidden opacity-50 lg:block">
                  ...
                  {process.env.NEXT_PUBLIC_WEBSITE_URL === "https://scheduler.hibox.co" ? "h" : "sh"}
            ...
            <span className="flex flex-grow items-center truncate">
              <span className="flex-grow truncate text-sm">
                ...
                <span className="block truncate font-normal text-neutral-500">
                  {user.username
                    ? process.env.NEXT_PUBLIC_WEBSITE_URL === "https://scheduler.hibox.co"
                      ? `scheduler.hibox.co/${user.username}`
                      : `/${user.username}`
                    : "No public page"}
                </span>
              </span>
